...
- [[https://github.com/ultronozm/doc-view-follow.el][doc-view-follow.el]] :: synchronize windows showing the same document
- [[https://github.com/ultronozm/eat-tmux.el][eat-tmux.el]] :: tmux views in Eat
- [[https://github.com/ultronozm/eldoc-icebox.el][eldoc-icebox.el]] :: pop-up buffer with frozen copy of eldoc
- [[https://github.com/ultronozm/flymake-overlays.el][flymake-overlays.el]] :: toggleable overlays for Flymake diagnostics
- [[https://github.com/ultronozm/library.el][library.el]] :: helper functions for managing downloaded papers
- [[https://github.com/ultronozm/llm-vc-commit.el][llm-vc-commit.el]] :: LLM-based commit message generator
...
- [[https://github.com/ultronozm/repo-scan.el][repo-scan.el]] :: Dired-like dashboard for a collection of Git repos
...
I'm using this config with Emacs "32.5", built from source, on MacOS.  To set this up on a fresh machine, I've done something like the following steps:
...
* Other fun tips
Here I'll collect miscellaneous things that I need to recreate my computing environment.

** Making git use color in eshell
#+begin_src sh
...
Do ~M-x server-start~ before using this.  And use ~C-x #~ (~server-edit~) when done editing.

** Path variable

#+begin_src sh
export PATH="/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:$HOME/.local/bin:$HOME/.cargo/bin:$HOME/.roswell/bin:$HOME/Library/Python/3.11/bin:/Library/TeX/texbin:/usr/bin:/bin:/usr/sbin:/sbin:$PATH:$HOME/gnu-emacs/src:$HOME/gnu-emacs/lib-src"
#+end_src
